...
def liverUnet(pretrained_weights = None,input_size = (512,512,1)):
...
def get_unet_sorr(input_size = (512,512,1)):
    inputs = Input(input_size)
    ...
    conv10 = Conv2D(input_size[2], (1, 1), activation='sigmoid')(conv9)
